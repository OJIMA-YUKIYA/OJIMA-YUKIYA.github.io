...
const ws1 = new WebSocket('wss://192.168.1.149:8081/ws');
ws1.onopen = onWsOpen.bind();
ws1.onerror = onWsError.bind();
ws1.onmessage = onWsMessage.bind();
